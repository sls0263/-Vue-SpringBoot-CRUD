    ...
    methods: {
      ...
      getData: function (initial) {
        ...
        fetch(
          ...
          .then((response) => response.json()) //console.log("response.data = "+response.data) //
          .then(json => {
            const total = Object.keys(json).length; //json['data.count'];
            console.log("response"+JSON.stringify(json));
            const data = JSON.stringify(json); //json['value'];
            console.log("data"+data);
            this.total = total;
            this.updatedData = [...data]; //Object.keys(json); 
            this.gridData = data;
